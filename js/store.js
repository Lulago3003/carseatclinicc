...
(function () {
  ...
  // Comparador "antes y después" de limpieza (deslizable + auto-demo al entrar)
  function setupBeforeAfter() {
    ...
    // CTA de WhatsApp para limpieza
    const cta = $("#limpiezaWhatsBtn");
    if (cta && CONFIG.whatsapp) {
      cta.href = `https://wa.me/${CONFIG.whatsapp}?text=${encodeURIComponent("Hola Car Seat Clinic 👋 Quiero información sobre la limpieza profunda de mi silla de carro.")}`;
      cta.target = "_blank";
      cta.rel = "noopener";
    }
