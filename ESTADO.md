...
- [x] Orden de la home (optimizado con CRO): Hero -> Franja de confianza -> Catalogo -> Encuentra tu silla -> Ruta segura -> 3 pilares -> Servicios (tarjetas) -> Nosotros -> Testimonios -> Cita -> Contacto. Fondos beige/blanco alternados. Quitado el "1:1" confuso del hero. Se elimino "Proceso simple" (journey) por redundante.
