...
- [x] Orden de la home reordenado de forma estrategica: Hero -> Ruta segura -> Encuentra tu silla -> Catalogo -> Servicios (tarjetas) -> Testimonios -> Alquiler -> Recursos -> Cita -> Nosotros -> Contacto. Quitado el "1:1" confuso del hero. Se elimino la seccion "Proceso simple" (journey) por ser redundante con Ruta segura.
