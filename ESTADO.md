...
- [x] Orden de la home: Hero -> Nosotros -> Catalogo -> Ruta segura -> Encuentra tu silla -> Servicios (tarjetas) -> Testimonios -> Cita -> Contacto. Quitado el "1:1" confuso del hero. Se elimino "Proceso simple" (journey) por redundante.
